      ...
      <div className="signinbody-right">
        <div className="signin-form-Wrapper">
          <div className="form-navbar">
            <div className="form-navbar-toggles">
              <h3
                onClick={() => {
          ...
          <div className="signin-form">
            ...
            <div className="form-input-fields">
              <input
                type="email"
                placeholder="Contact"
                value={userSignin.contact}
                onChange={(e) =>
                  setUserSignin({ ...userSignin, contact: e.target.value })
                }
              />
              <input
                type="password"
              ...
              />
              {passwordErr && (
                <span className="signin-passwordError" style={{ color: "red" }}>
                  {passwordErrMessage}
                </span>
              )}
            </div>
                ...
                onClick={async (e) => {
                  ...
                  try {
                    const response = await fetch(
                      "https://omni-food-backend-1.onrender.com/user/login",
                      {
                        method: "POST",
                        headers: {
